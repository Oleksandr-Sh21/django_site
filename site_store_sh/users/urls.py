...
urlpatterns = [
    ...
    path('add-favorite/<int:product_id>', views.AddFavorite.as_view(), name='add_favorite'),
    path('remove-favorite/<int:product_id>', views.RemoveFavorite.as_view(), name='remove_favorite'),
